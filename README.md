...
If you use MetaWorks 2.0 in research, cite the archived software release using [CITATION.cff](CITATION.cff) when a release DOI is available, and cite the MetaWorks paper:
